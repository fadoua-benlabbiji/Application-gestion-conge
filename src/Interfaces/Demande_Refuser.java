 ...
 * @author ELITEBOOK
 */
public class Demande_Refuser extends javax.swing.JFrame {

    /**
     * Creates new form Admin
     */
    public Demande_Refuser() {
       initComponents();
         chargerDonnees();
...
for (int i = 0; i < jTable1.getColumnCount(); i++) {
    ...
    model.setRowCount(0); // Vider les anciennes lignes
       String URL = "jdbc:mysql://localhost:3306/gestion_conge";
        ...
        String MOT_DE_PASSE = "";  
           String query = "SELECT matricule, date_debut, date_fin, type_conge, statut FROM demandes WHERE statut = 'refusée'";
        //connexion
    ...
    private void initComponents() {
        ...
        Gestion1 = new javax.swing.JButton();
        Gestion3 = new javax.swing.JButton();
        ...
        jLabel3.setText("Les demandes Refuser");
        ...
        Gestion1.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        Gestion1.setForeground(new java.awt.Color(51, 0, 255));
        Gestion1.setText("Demande en cours");
        Gestion1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Gestion1ActionPerformed(evt);
            }
        });

        Gestion3.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        Gestion3.setForeground(new java.awt.Color(51, 0, 255));
        Gestion3.setText("Demande En cours");
        Gestion3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Gestion3ActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Gestion3, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    ...
                    .addComponent(Gestion1, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(253, 253, 253)))
        );
    ...
    private void Gestion1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Gestion1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Gestion1ActionPerformed

    private void Gestion3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Gestion3ActionPerformed
        Gestion_demande win= new  Gestion_demande();
        win.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_Gestion3ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Demande_Refuser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Demande_Refuser().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton Gestion1;
    private javax.swing.JButton Gestion3;
